...
public class EShopController {
    ...
    public static void purchaseShoppingCart(ShoppingCart cart, String customerName, String customerAddress, Storage storage, PurchasesArchive archive) throws Exception {
        if (cart.getCartItems().isEmpty()) {
            System.out.println("Error: shopping cart is empty");
            throw new Exception("OMG ITS A CHYBA");
        }
...
public static void main(String[] args) throws Exception {
        ...
        purchaseShoppingCart(newCart, "Libuse Novakova","Kosmonautu 25, Praha 8", storage, archive);
        ...
        purchaseShoppingCart(newEmptyCart, "Jarmila Novakova", "Spojovaci 23, Praha 3", storage, archive);
